...
<body>
  <div class="wrap">
    ...
    <p class="lead">Please Click <strong>Continue</strong> to proceed. <br> 
      <strong>Watch Video <i class="ellipsis">${video.title}</i></strong></p>
  ...
  <script>
    (function(){
      ...
      // semua JS progress bar lo paste di sini
    })();
  </script>

  <div class="sticky-ads" id="sticky-ads">
    <!-- iklan sticky lo masuk sini -->
  </div>
</body>
</html>
          `,
